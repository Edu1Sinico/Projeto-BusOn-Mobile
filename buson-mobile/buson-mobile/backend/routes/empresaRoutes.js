...
const {buscarEmpresas, adicionarFavoritos, removerFavoritos, buscarFavoritos } = require('../controllers/empresaController'); // busca o método "criarUsuario" do controller
