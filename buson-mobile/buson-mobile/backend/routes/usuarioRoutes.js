...
const { criarUsuario,completarCadastro, buscarUsuario } = require('../controllers/usuarioController'); // busca o método "criarUsuario" do controller
...
router.post('/completarCadastro', completarCadastro );
